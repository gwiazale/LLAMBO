...
Performance: {A}"""
        ...
        if use_context == 'full_context':
            if dataset_type == 'image':
                ...
                prefix += f" The model is evaluated on {ds_desc}. Each configuration specifies a NAS-Bench-201 architecture index and training hyperparameters (learning rate, weight decay, batch size, optimizer, scheduler)."
            else:
